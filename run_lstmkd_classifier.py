...
def train_titanic(configs, checkpoint_dir=None, train_dir=None, valid_dir=None, glove_dir=None, word2vec_dir=None):
    ...
    wvmodel = gensim.models.KeyedVectors.load_word2vec_format(
        '/home/dongxx/projects/def-mercer/dongxx/project/word2vec/glove.6B.word2vec.100d.txt', binary=False,
        encoding='utf-8')
    dimensions = 100
    count = 400001
    ...
    model = LSTMBaseline(dimensions, configs["hidden_dim"], config.N_LAYERS, config.DROPOUT, config.OUTPUT_DIM,
                         config.BIDIRECTIONAL, embedding)
