...
def prepare_dateset(train_data_path, validation_data_path,test_data_path,vocab):
    ...
    training_logits = training.prompt_logit
...
def main():
    ...
    for epoch in range(25):
        ...
        if valid_loss < best_loss:
            ...
            torch.save(LSTM_atten_model.state_dict(), config.MODEL_Base_PATH_prompt_kd)
    print("training done")

    print("testing")
    LSTM_atten_model.load_state_dict(torch.load(config.MODEL_Base_PATH_prompt_kd))
