...
#         counter1[x] = 400000-int(y)
    ...
    for epoch in range(args.num_epochs):
        ...
        if valid_loss < best_loss:
            ...
            torch.save(LSTM_model.state_dict(), '/home/dongxx/projects/def-mercer/dongxx/project/Model_parameter/fk.pt')
    print("training done")

    print("testing")

    LSTM_model.load_state_dict(torch.load('/home/dongxx/projects/def-mercer/dongxx/project/Model_parameter/fk.pt'))
