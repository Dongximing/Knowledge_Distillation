...
#         counter1[x] = 400000-int(y)
    ...
    LSTM_model =LSTMBaseline(vocab_size = vocab_size,hidden_dim = config.HIDDEN_DIM, n_layers =1, dropout = args.dropout, number_class = args.number_class, bidirectional = True, embedding_dim =100)
